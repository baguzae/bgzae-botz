...
let handler = async (m, { conn }) => {
    ...
    if (!img) throw img
    await conn.sendFile(m.chat, img, '', '© *Baguzae* nih EXOnya jangan lupa subscribe channel https://m.youtube.com/c/ranzstars 👍', m, 0, { thumbnail: await (await fetch(img)).buffer() })
}
handler.help = ['exo']
